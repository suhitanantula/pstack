...
import type { PstackAgent } from "./server";
import {
  Badge,
  Button,
  Empty,
...
function Chat() {
  ...
  const agent = useAgent<PstackAgent>({
    agent: "PstackAgent",
        ...
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-lg font-semibold text-kumo-default">
              <span className="mr-2">⛅</span>PSTACK on Cloudflare
            </h1>
            ...
            <Empty
              ...
              contents={
                <div className="flex flex-wrap justify-center gap-2">
                  {[
                    "Start in Perceive. What are the real signals in this problem?",
                    "Loop to Portfolio and sketch 3 viable options.",
                    "Pause-Promote this portfolio and recommend the next bet.",
                    "Record where human judgment is needed in this loop."
                  ].map((prompt) => (
                    <Button
                      key={prompt}
                      variant="outline"
